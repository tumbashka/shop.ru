                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="old_price" class="form-control" id="old_price"
                               placeholder="Старая цена" value="<?= sessionFormData('old_price') ?: 0 ?>">
                    </div>
                </div>
            </div>
                            ...
                            <div class="tab-pane fade <?php if ($lang['base']) echo 'active show' ?>" id="<?= $k ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][title]"
                                           ...
                                           value="<?= get_field_array_value($_SESSION, 'form_data', 'product_description', $lang['id'], 'title') ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][description]"
                                           ...
                                           value="<?= get_field_array_value($_SESSION, 'form_data', 'product_description', $lang['id'], 'description') ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][keywords]"
                                           ...
                                           value="<?= get_field_array_value($_SESSION, 'form_data', 'product_description', $lang['id'], 'keywords') ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][excerpt]"
                                           ...
                                           value="<?= get_field_array_value($_SESSION, 'form_data', 'product_description', $lang['id'], 'excerpt') ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="product_description[<?= $lang['id'] ?>][content]"
                                              ...
                                              placeholder="Описание товара"><?= get_field_array_value($_SESSION, 'form_data', 'product_description', $lang['id'], 'content') ?></textarea>
                                </div>
