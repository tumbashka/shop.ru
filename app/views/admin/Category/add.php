                            ...
                            <div class="tab-pane fade <?php if ($lang['base']) echo 'active show' ?>" id="<?= $k ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_description[<?= $lang['id'] ?>][title]"
                                           class="form-control" id="title" placeholder="Наименование категории"
                                           value="<?= get_field_array_value($_SESSION, 'form_data', 'category_description', $lang['id'], 'title') ?>"
                                           required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_description[<?= $lang['id'] ?>][description]"
                                           ...
                                           value="<?= get_field_array_value($_SESSION, 'form_data', 'category_description', $lang['id'], 'description') ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_description[<?= $lang['id'] ?>][keywords]"
                                           ...
                                           value="<?= get_field_array_value($_SESSION, 'form_data', 'category_description', $lang['id'], 'keywords') ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="category_description[<?= $lang['id'] ?>][content]"
                                              ...
                                              placeholder="Описание категории"><?= get_field_array_value($_SESSION, 'form_data', 'category_description', $lang['id'], 'content') ?></textarea>
                                </div>
