...
<?php if (!empty($products)): ?>
    <section class="featured-products">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="section-title"><?=getLang('main_index_featured_products') ?></h3>
                </div>
...
<section class="services">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="section-title"><?= getLang('main_index_advantages') ?></h3>
            </div>

            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    <p class="text-center"><i class="fas fa-shipping-fast"></i></p>
                    <p><?= getLang('main_index_delivery') ?></p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p><?= getLang('main_index_assortment') ?></p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="service-item">
                    ...
                    <p><?= getLang('main_index_service') ?></p>
                </div>
            </div>
